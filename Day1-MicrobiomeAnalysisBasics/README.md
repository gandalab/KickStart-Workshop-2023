# Day 2 - Microbiome Analysis Basics
...
2. Sampling (Sharifa Crandall) - pdf  
3. Controls/Contamination (Emily Davenport - slides by Laura Weyrich) - pdf
...
7. Downstream analysis and other tools (Estelle Couradeau) - pdf
